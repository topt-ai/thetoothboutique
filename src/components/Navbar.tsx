    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link to="/blanqueamiento" className="font-body font-normal text-[13px] text-white tracking-[0.08em] hover:text-accent transition-colors">Blanqueamiento</Link>
        </div>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-dark/95 backdrop-blur-lg flex flex-col items-center justify-center gap-8 md:hidden">
          ...
          <Link to="/blanqueamiento" onClick={() => setIsMobileMenuOpen(false)} className="font-body text-2xl text-white tracking-widest">Blanqueamiento</Link>
          <a
            href="https://wa.me/50379056000"
            target="_blank"
            rel="noopener noreferrer"
