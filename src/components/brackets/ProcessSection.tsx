  ...
  const steps = [
    {
      ...
      body: 'Evaluamos tu caso con radiografías y modelos digitales para crear un plan personalizado.',
    },
    {
      number: '02',
      title: 'Colocación de Brackets',
      body: 'Colocamos cuidadosamente los brackets y el alambre inicial para comenzar el movimiento dental.',
    },
    {
      number: '03',
      title: 'Ajustes Regulares',
      body: 'Citas mensuales para ajustar los alambres y monitorear el progreso del tratamiento.',
    },
    {
      number: '04',
      title: 'Seguimiento del Progreso',
      body: 'Monitoreamos continuamente el movimiento dental y ajustamos el plan según sea necesario.',
    },
    {
      number: '05',
      title: 'Retiro y Retención',
      body: 'Retiramos los brackets y colocamos retenedores para mantener los resultados obtenidos.',
    },
  ];

  return (
    <section ref={sectionRef} id="proceso" className="py-[120px] px-8 md:px-[8%] bg-bg">
