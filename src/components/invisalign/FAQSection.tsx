...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'El costo de Invisalign varía según la complejidad de cada caso. Para darte un precio exacto, hacemos una evaluación inicial de $65 que incluye escaneo 3D, fotos y diagnóstico completo, donde te entregamos un plan de tratamiento con el costo específico para tu caso.',
    },
  ];
