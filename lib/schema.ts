...
const areaServed = SITE.areas.map((area) => ({ '@type': area.type, name: area.name }));
...
export function clinicNode() {
  return {
    ...
    aggregateRating: { '@type': 'AggregateRating', ratingValue: '5.0', reviewCount: '134', bestRating: '5', worstRating: '1' },
